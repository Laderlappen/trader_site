      ...
      <Wrapper>
        <div className={styles.main}>
          ...
          <div className={styles.description}>
            <span>Get started by downloading our trading software:</span>
            <Button
              className={styles.code}
              onClick={() =>
                window.innerWidth > 960 ? setShowModal(true) : ""
              }
            >
              DB Trading Software
            </Button>
          ...
          <Modal onClose={() => setShowModal(false)} show={showModal}>
            <p className={styles.termstitle}>Terms and Conditions:</p>
            <p className={styles.terms}>
              By downloading this trading client you accept that DB Capital or
              any of its employees or associates are not liable for any
              financial loss. Use this software at your own risk with money you
              can afford to lose.
            </p>
